  ...
  return (
    ...
    <div className="w-full mx-auto mt-20 px-6 sm:px-8 lg:px-16" id="countryLinks">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        >
          <Link href="/costa_rica/green_life_conservation" className="relative h-0 pb-56 block">
            <img
        ...
        <motion.div
          ...
          className="relative overflow-hidden rounded-lg shadow-md cursor-pointer w-full"
        >
          <Link href="/costa_rica/green_life_community" className="relative h-0 pb-56 block">
            <img
