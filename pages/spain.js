          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="flex flex-col justify-center">
              ...
              <p className="text-xl leading-relaxed mb-4">
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;From Barcelona to Madrid to
                Seville, an overseas experience in Spain means the chance to
                immerse yourself in art, history, and a buzzing social scene. If
                those Canadian winters are getting too long and cold for you,
                Spain’s beautiful coastlines and picturesque towns provide the
                perfect escape for those who love sun and sand. Spanish culture
                prioritizes leisure, allowing you to enjoy siestas, long
                lunches, and plenty of time to explore the country while
                working.
              </p>
