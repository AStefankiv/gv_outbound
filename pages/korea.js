...
const KoreaPage = () => {
  return (
    <div className="flex flex-col min-h-screen">
      <header className="fixed top-0 w-full z-30 bg-white transition-all shadow-md pt-4">
          ...
          >
            <Link href="/korea/teach_eng_korea_form">
              <a>
                ...
                <div
                  className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50 text-white text-2xl font-bold"
                  style={{ color: "white" }}
                >
                  TEACH ENGLISH
                </div>
