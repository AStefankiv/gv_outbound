...
const ItalyTeachEngForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const response = await fetch('/api/send-email', {
      ...
      body: JSON.stringify({ ...formData, subject: 'Italy Language Assistant' }),
    });
        ...
        <h1 className="text-4xl lg:text-5xl font-medium leading-relaxed text-black-600 mb-6">
            ...
            <div className="w-2/3 mx-auto">
              <form onSubmit={handleSubmit} className="grid grid-cols-1 gap-6">
                ...
                Yes! I want to know how I can become a Language Assistant in Italy!
                </h1>
...
export default ItalyTeachEngForm;
